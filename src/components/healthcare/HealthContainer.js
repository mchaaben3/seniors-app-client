...
const HealthContainer = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col lg:grid lg:grid-cols-5 lg:gap-4   ml-4 p-4">
        {ALL_ARTICLES&&ALL_ARTICLES.ARTICLES == null  ? <BarLoader loading  /> : 
        ALL_ARTICLES.ARTICLES.map((u)=>(
          <Health title={u.article_title} body={u.article} image={u.post_url}/>
        ))
