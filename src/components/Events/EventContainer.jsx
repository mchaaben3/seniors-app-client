...
const EventContainer = ({ user, userConnected }) => {
  ...
  return (
    <>
      <div className="container flex flex-col items-center justify-center  mt-24">
        {isBlocked === true ? (
      ...
      <div className="container flex flex-col justify-center w-full lg:grid lg:grid-cols-4 lg:gap-4 md:grid md:grid-cols-2 md:gap-4 mt-4 pl-4  lg:h-auto">
        {ALL_EVENTS &&
